...
class do_sp_SystemCheck {
    ...
    public function __construct() {
        $this->options = get_site_option( 'do_sp_systemcheck_v2.0.2' );
    }
    ...
    private function checkWordPressVersion() {
        ...
        if ( !function_exists( 'wp_enqueue_media' ) ) {
            $error = "DO_Stelselplaat requires WordPress 3.5 or above. Please upgrade your WordPress installation.";
